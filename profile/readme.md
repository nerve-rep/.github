...
ИИ используется как инструмент ускорения.
Я самостоятельно проектировал архитектуру, декомпозировал задачи, создавал промпты, выполнял ревью сгенерированного кода и вносил корректировки, обеспечивая качество и стабильность.
<br /><br />
